...
public:
	...
	void append_item(unsigned long long);
	void append_item(uint8_t*, int);	
	void append_item(const char*);	
	void append_item(string);
	void append_gtpc_hdr(uint8_t, uint16_t, uint32_t);
	void append_gtpu_hdr(uint8_t, uint16_t, uint32_t);
	void append_s1ap_hdr(uint8_t, uint16_t, uint32_t, uint32_t);
	void append_diameter_hdr(uint8_t, uint16_t);
